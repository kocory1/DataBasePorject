...
public class Db1 {
	...
	public static Connection getRootConnection() throws ClassNotFoundException, SQLException {
		...
		return DriverManager.getConnection("jdbc:mysql://localhost:3306/camping_car_db", "root", "kingpin100");
	}

	// ✅ user1 계정용 연결 (일반회원 로그인용)
	public static Connection getUserConnection() throws ClassNotFoundException, SQLException {
		Class.forName("com.mysql.cj.jdbc.Driver");
		return DriverManager.getConnection("jdbc:mysql://localhost:3306/camping_car_db", "user1", "user1");
	}
}
